        ...
        <div class="card" style="overflow:hidden;">
            ...
            <div class="hero-card">
                ...
                <div class="hero-overlay">
                    ...
                    {{-- Preço no banner, abaixo do endereço --}}
                    <div class="hero-meta" style="gap: 0.5rem; font-weight: 800;">
            ...
            <div class="card-body">
                ...
                <div class="form-grid columns-2" style="gap: 1rem; margin-bottom: 1.5rem;">
                    ...
                    {{-- Removido o card "Valor do Ingresso" para evitar duplicidade, preço está no banner --}}
