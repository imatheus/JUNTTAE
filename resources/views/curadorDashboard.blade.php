        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-8">
                        <div class=" bg-gray-300 rounded-lg relative overflow-hidden shadow-lg">
                            ...
                            <div class="absolute inset-0 bg-black bg-opacity-40 p-4 flex flex-col justify-end">
                                <h3 class="text-4xl font-extrabold text-white">{{ $eventoDestaque->nome }}</h3>
                                <p class="text-xl text-white">{{ $eventoDestaque->subtitulo ?? $eventoDestaque->local }}</p> 
                                <div class="flex items-center text-white mt-2">
                                    ...
                                    {{-- Data Dinâmica: Formate a coluna de data (ex: data_inicio) --}}
                                    <span class="text-sm">{{ \Carbon\Carbon::parse($eventoDestaque->data_inicio)->format('d/m/Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <h4 class="text-2xl font-bold mb-4 border-b pb-2">Eventos Cadastrados</h4>
                    ...
                    @empty
                        <p class="text-gray-500 dark:text-gray-400">Nenhum evento cadastrado ainda.</p>
                    @endforelse
